...
type Order struct {
	...
	Trasaction   Trasaction `json:"trasaction"`
...
func (m *DBModel) GetAllOrders() ([]*Order, error) {
	...
	for rows.Next() {
		var o Order
		err = rows.Scan(
			&o.ID, &o.WidgetID, &o.TrasactionID, &o.CustomerID,
			&o.StatusID, &o.Quantity, &o.Amount, &o.CreatedAt, &o.UpdatedAt,
			&o.Widget.ID, &o.Widget.Name,
			&o.Trasaction.ID, &o.Trasaction.Amount, &o.Trasaction.Currency,
			&o.Trasaction.LastFour, &o.Trasaction.ExpiryMonth, &o.Trasaction.ExpiryYear,
			&o.Trasaction.PaymentIntent, &o.Trasaction.PaymentMethod, &o.Trasaction.BankReturnCode,
